package conf.web.rest;

import conf.ConfApp;

import conf.domain.Speaker;
import conf.repository.SpeakerRepository;
import conf.web.rest.errors.ExceptionTranslator;
...
import static conf.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = ConfApp.class)
